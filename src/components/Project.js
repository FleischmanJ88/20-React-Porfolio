export default function Project ({project}) {
  return (
    <a href={project.url} className='relative border-[5px] border-highlight cursor-pointer text-black	'>
      <div className='absolute w-full h-full bg-dark opacity-20 hover:opacity-0 duration-200'></div>
      <div className='absolute w-[60%] bottom-[1%] bg-highlight p-2 pointer-events-none'>
